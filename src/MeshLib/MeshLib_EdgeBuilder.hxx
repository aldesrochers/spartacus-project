...
#ifndef __MeshLib_EdgeBuilder_hxx__
#define __MeshLib_EdgeBuilder_hxx__

// Spartacus
#include <MeshDS_Edge.hxx>
#include <MeshDS_Vertex.hxx>
#include <MeshLib_EdgeError.hxx>
...
// ============================================================================
/*!
 *  \brief MeshLib_EdgeBuilder
*/
// ============================================================================
class MeshLib_EdgeBuilder
{
...
public:
    // constructors
    Standard_EXPORT MeshLib_EdgeBuilder(const MeshDS_Vertex& theVertex1,
                                        const MeshDS_Vertex& theVertex2);
    // destructors
    Standard_EXPORT ~MeshLib_EdgeBuilder();
...
public:
    ...
    Standard_EXPORT MeshLib_EdgeError       Error() const;
...
protected:
    ...
    MeshDS_Edge                     myEdge;
    MeshLib_EdgeError               myError;
    MeshTools_IndexedMapOfObject    myVertices;

};


#endif // __MeshLib_EdgeBuilder_hxx__
