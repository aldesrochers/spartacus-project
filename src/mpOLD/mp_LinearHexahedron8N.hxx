...
#ifndef __mp_LinearHexahedron8N_hxx__
#define __mp_LinearHexahedron8N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_LinearHexahedron8N
*/
// ============================================================================
class mp_LinearHexahedron8N
{
...
public:
    // constructors
    Standard_EXPORT mp_LinearHexahedron8N();
    Standard_EXPORT mp_LinearHexahedron8N(const Standard_Integer theNode1,
...
public:
    ...
    Standard_EXPORT mp_QuadrangleFace4N     Face1() const;
    Standard_EXPORT mp_QuadrangleFace4N     Face2() const;
    Standard_EXPORT mp_QuadrangleFace4N     Face3() const;
    Standard_EXPORT mp_QuadrangleFace4N     Face4() const;
    Standard_EXPORT mp_QuadrangleFace4N     Face5() const;
    Standard_EXPORT mp_QuadrangleFace4N     Face6() const;
...
#endif // __mp_LinearHexahedron8N_hxx__
