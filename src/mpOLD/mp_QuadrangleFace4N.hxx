...
#ifndef __mp_QuadrangleFace4N_hxx__
#define __mp_QuadrangleFace4N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_QuadrangleFace4N
*/
// ============================================================================
class mp_QuadrangleFace4N
{
...
public:
    // constructors
    Standard_EXPORT mp_QuadrangleFace4N();
    Standard_EXPORT mp_QuadrangleFace4N(const Standard_Integer theNode1,
...
public:
    ...
    Standard_EXPORT mp_Edge2N           Edge1() const;
    Standard_EXPORT mp_Edge2N           Edge2() const;
    Standard_EXPORT mp_Edge2N           Edge3() const;
    Standard_EXPORT mp_Edge2N           Edge4() const;
...
#endif // __mp_QuadrangleFace4N_hxx__
