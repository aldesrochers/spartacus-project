...
public:
    ...
    Standard_EXPORT const MeshDS_SequenceOfObject&  Cells() const;
    Standard_EXPORT MeshDS_SequenceOfObject&        Cells();
    Standard_EXPORT const MeshDS_SequenceOfObject&  Groups() const;
    Standard_EXPORT MeshDS_SequenceOfObject&        Groups();
    Standard_EXPORT const MeshDS_SequenceOfObject&  Vertices() const;
    Standard_EXPORT MeshDS_SequenceOfObject&        Vertices();

private:

    MeshDS_SequenceOfObject     myCells;
    MeshDS_SequenceOfObject     myGroups;
