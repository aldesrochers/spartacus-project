...
public:
    ...
    Standard_EXPORT const Handle(DOF_DegreeOfFreedom)&  Model() const;
    Standard_EXPORT void                                SetModel(const Handle(DOF_DegreeOfFreedom)& theModel);

private:

    Handle(DOF_DegreeOfFreedom)     myModel;
