...
#ifndef __MeshFunc_CurveNbSegments_hxx__
#define __MeshFunc_CurveNbSegments_hxx__
...
// ============================================================================
/*!
 *  \brief MeshFunc_CurveNbSegments
...
*/
// ============================================================================
class MeshFunc_CurveNbSegments : public math_FunctionSetWithDerivatives
{
...
public:
    // constructors
    Standard_EXPORT MeshFunc_CurveNbSegments(const Adaptor3d_Curve& theCurve,
                                             const Standard_Integer theNbSegments);
    // destructors
    Standard_EXPORT ~MeshFunc_CurveNbSegments();
...
#endif // __MeshFunc_CurveNbSegments_hxx__
