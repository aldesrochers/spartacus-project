...
*/
// ============================================================================
MeshFunc_CurveNbSegments::MeshFunc_CurveNbSegments(const Adaptor3d_Curve &theCurve,
...
*/
// ============================================================================
MeshFunc_CurveNbSegments::~MeshFunc_CurveNbSegments()
{
...
*/
// ============================================================================
Standard_Boolean MeshFunc_CurveNbSegments::Derivatives(const math_Vector &X,
                                                       math_Matrix &D)
{
...
*/
// ============================================================================
Standard_Integer MeshFunc_CurveNbSegments::NbEquations() const
{
...
*/
// ============================================================================
Standard_Integer MeshFunc_CurveNbSegments::NbVariables() const
{
    return myNbSegments - 1;
}
...
*/
// ============================================================================
Standard_Boolean MeshFunc_CurveNbSegments::Value(const math_Vector &X,
                                                 math_Vector &F)
{
    for(Standard_Integer i=1; i<=NbVariables(); i++) {
...
*/
// ============================================================================
Standard_Boolean MeshFunc_CurveNbSegments::Values(const math_Vector &X,
                                                  math_Vector &F,
                                                  math_Matrix &D)
{
    if(!Derivatives(X, D))
