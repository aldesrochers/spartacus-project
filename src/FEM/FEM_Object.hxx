...
#ifndef __FE_Point_hxx__
#define __FE_Point_hxx__
...
// Handles
DEFINE_STANDARD_HANDLE(FE_Point, Standard_Transient)
...
*/
// ============================================================================
class FE_Point : public Standard_Transient
{

public:
    // constructors
    Standard_EXPORT FE_Point();
    // destructors
    Standard_EXPORT ~FE_Point();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(FE_Point, Standard_Transient)

};


#endif // __FE_Point_hxx__
