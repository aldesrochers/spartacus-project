...
#ifndef __Cell2d_Shape_hxx__
#define __Cell2d_Shape_hxx__
...
// Handles
DEFINE_STANDARD_HANDLE(Cell2d_Shape, Standard_Transient)
...
*/
// ============================================================================
class Cell2d_Shape : public Standard_Transient
{

public:
    // constructors
    Standard_EXPORT Cell2d_Shape();
    // destructors
    Standard_EXPORT ~Cell2d_Shape();
...
public:
    ...
    Standard_EXPORT const gp_Pnt2d&         Point(const Standard_Integer theIndex) const;
...
protected:
    ...
    TColgp_SequenceOfPnt2d      myPoints;
    TopTools_SequenceOfShape    myVertices;
    TopTools_SequenceOfShape    myWires;

public:

    DEFINE_STANDARD_RTTIEXT(Cell2d_Shape, Standard_Transient)

};


#endif // __Cell2d_Shape_hxx__
