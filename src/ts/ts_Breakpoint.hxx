...
#ifndef __ts_Breakpoint_hxx__
#define __ts_Breakpoint_hxx__
...
public:
    // constructors
    Standard_EXPORT ts_Breakpoint();
    Standard_EXPORT ts_Breakpoint(const Standard_Real theTime,
