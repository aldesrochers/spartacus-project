...
#ifndef __Huygens_Scene_hxx__
#define __Huygens_Scene_hxx__
...
*/
// ============================================================================
class Standard_EXPORT Huygens_Scene : public QWidget, protected AIS_ViewController
{
    Q_OBJECT

public:
    // constructors
    Huygens_Scene(QWidget* theParent = nullptr);
    Huygens_Scene(Handle(V3d_View) theView,
