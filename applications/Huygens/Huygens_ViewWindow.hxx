...
#ifndef __Huygens_ViewWindow_hxx__
#define __Huygens_ViewWindow_hxx__
...
// ============================================================================
/*!
 *  \brief Huygens_ViewWindow
*/
// ============================================================================
class Huygens_ViewWindow : public Aspect_Window
{

public:
    // constructors
    Huygens_ViewWindow(QWidget* theWidget,
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Huygens_ViewWindow, Aspect_Window);

};


#endif // __Huygens_ViewWindow_hxx__
