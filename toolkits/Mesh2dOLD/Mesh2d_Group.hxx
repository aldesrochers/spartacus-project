...
#ifndef __Mesh2d_Group_hxx__
#define __Mesh2d_Group_hxx__
...
// Handles
DEFINE_STANDARD_HANDLE(Mesh2d_Group, Mesh2d_Object)
...
*/
// ============================================================================
class Mesh2d_Group : public Mesh2d_Object
{
...
public:
    // constructors
    Standard_EXPORT Mesh2d_Group();
    Standard_EXPORT Mesh2d_Group(const Standard_Integer theNbCells);
    Standard_EXPORT Mesh2d_Group(const TColStd_Array1OfInteger& theCells);
    // destructors
    Standard_EXPORT ~Mesh2d_Group();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Mesh2d_Group, Mesh2d_Object);

};


#endif // __Mesh2d_Group_hxx__
