...
public:
    ...
    Standard_EXPORT const Mesh2d_Array1OfCell&  Cells() const;
    Standard_EXPORT const Handle(Mesh2d_Group)& Group(const Standard_Integer theIndex) const;
    Standard_EXPORT const Mesh2d_Array1OfGroup& Groups() const;
    ...
    Standard_EXPORT const Mesh2d_Array1OfNode&  Nodes() const;
