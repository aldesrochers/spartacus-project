...
#ifndef __Mesh2d_LinearTriangle3N_hxx__
#define __Mesh2d_LinearTriangle3N_hxx__
...
class Mesh2d_LinearTriangle3N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh2d_LinearTriangle3N, Mesh2d_Cell)


// ============================================================================
/*!
 *  \brief Mesh2d_LinearTriangle3N
*/
// ============================================================================
class Mesh2d_LinearTriangle3N : public Mesh2d_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh2d_LinearTriangle3N();
    Standard_EXPORT Mesh2d_LinearTriangle3N(const mp_LinearTriangle3N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh2d_LinearTriangle3N();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Mesh2d_LinearTriangle3N, Mesh2d_Cell);

};


#endif // __Mesh2d_LinearTriangle3N_hxx__
