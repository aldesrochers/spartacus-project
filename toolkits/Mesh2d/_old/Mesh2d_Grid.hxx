...
#include <TColmp_Array1OfNode2d.hxx>
...
public:
    ...
    Standard_EXPORT const mp_Node2d&                        Node(const Standard_Integer theIndex) const;
    Standard_EXPORT const TColmp_Array1OfNode2d&            Nodes() const;
    Standard_EXPORT TColmp_Array1OfNode2d&                  Nodes();
