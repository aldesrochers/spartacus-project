...
#ifndef __Mesh2d_QuadraticQuadrangle8N_hxx__
#define __Mesh2d_QuadraticQuadrangle8N_hxx__
...
class Mesh2d_QuadraticQuadrangle8N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh2d_QuadraticQuadrangle8N, Mesh2d_Cell)


// ============================================================================
/*!
 *  \brief Mesh2d_QuadraticQuadrangle8N
*/
// ============================================================================
class Mesh2d_QuadraticQuadrangle8N : public Mesh2d_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh2d_QuadraticQuadrangle8N();
    Standard_EXPORT Mesh2d_QuadraticQuadrangle8N(const mp_QuadraticQuadrangle8N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh2d_QuadraticQuadrangle8N();
...
public:
    ...
    Standard_EXPORT const mp_QuadraticQuadrangle8N&     Connectivity() const;
    Standard_EXPORT void                                SetConnectivity(const mp_QuadraticQuadrangle8N& theConnectivity);
...
private:
    ...
    mp_QuadraticQuadrangle8N     myConnectivity;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh2d_QuadraticQuadrangle8N, Mesh2d_Cell);

};


#endif // __Mesh2d_QuadraticQuadrangle8N_hxx__
