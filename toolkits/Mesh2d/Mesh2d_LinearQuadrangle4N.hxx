...
#ifndef __Mesh2d_LinearQuadrangle4N_hxx__
#define __Mesh2d_LinearQuadrangle4N_hxx__
...
class Mesh2d_LinearQuadrangle4N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh2d_LinearQuadrangle4N, Mesh2d_Cell)


// ============================================================================
/*!
 *  \brief Mesh2d_LinearQuadrangle4N
*/
// ============================================================================
class Mesh2d_LinearQuadrangle4N : public Mesh2d_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh2d_LinearQuadrangle4N();
    Standard_EXPORT Mesh2d_LinearQuadrangle4N(const mp_LinearQuadrangle4N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh2d_LinearQuadrangle4N();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Mesh2d_LinearQuadrangle4N, Mesh2d_Cell);

};


#endif // __Mesh2d_LinearQuadrangle4N_hxx__
