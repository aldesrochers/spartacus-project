...
#ifndef __cmp_Elastic_hxx__
#define __cmp_Elastic_hxx__
...
public:
    // constructors
    Standard_EXPORT cmp_Elastic();
    Standard_EXPORT cmp_Elastic(const Standard_Real theE,
