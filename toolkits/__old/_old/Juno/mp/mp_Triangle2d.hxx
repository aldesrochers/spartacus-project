...
#ifndef __mp_Triangle2d_hxx__
#define __mp_Triangle2d_hxx__
...
public:
    // constructors
    Standard_EXPORT mp_Triangle2d();
    Standard_EXPORT mp_Triangle2d(const gp_Pnt2d& thePoint1,
