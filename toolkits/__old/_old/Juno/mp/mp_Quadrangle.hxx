...
#ifndef __mp_Quadrangle_hxx__
#define __mp_Quadrangle_hxx__
...
public:
    // constructors
    Standard_EXPORT mp_Quadrangle();
    Standard_EXPORT mp_Quadrangle(const Standard_Integer theNode1,
