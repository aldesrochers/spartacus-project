...
mp_LinearTriangle3N::mp_LinearTriangle3N(const Standard_Integer theNode1,
    ...
    : myTriangle(theNode1, theNode2, theNode3)
{
...
*/
// ============================================================================
const mp_Triangle& mp_LinearTriangle3N::Triangle() const
{
    return myTriangle;
}
