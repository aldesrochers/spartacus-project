...
#ifndef __mp_LinearLine3N_hxx__
#define __mp_LinearLine3N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_LinearLine3N
*/
// ============================================================================
class mp_LinearLine3N
{
...
public:
    // constructors
    Standard_EXPORT mp_LinearLine3N();
    Standard_EXPORT mp_LinearLine3N(const Standard_Integer theNode1,
...
public:
    ...
    Standard_EXPORT const mp_Line&      Line1() const;
    Standard_EXPORT const mp_Line&      Line2() const;
