...
// Handles
DEFINE_STANDARD_HANDLE(VVM_Mesh, VVM_BaseMesh);
...
*/
// ============================================================================
class VVM_Mesh : public VVM_BaseMesh
{
...
public:
    ...
    Standard_EXPORT const VVM_Node&             Node(const Standard_Integer theIndex) const;
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(VVM_Mesh, VVM_BaseMesh);
