...
public:
    ...
    Standard_EXPORT MeshDS_ListOfObject&                        Nodes();
    Standard_EXPORT const Handle(MeshDS_CellRepresentation)&    Representation() const;
    Standard_EXPORT void                                        SetRepresentation(const Handle(MeshDS_CellRepresentation)& theRepresentation);

private:

    MeshDS_ListOfObject                 myNodes;
    Handle(MeshDS_CellRepresentation)   myRepresentation;
