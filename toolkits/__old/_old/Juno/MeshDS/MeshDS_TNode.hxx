...
public:
    ...
    Standard_EXPORT const Handle(MeshDS_NodeRepresentation)&    Representation() const;
    Standard_EXPORT void                                        SetRepresentation(const Handle(MeshDS_NodeRepresentation)& theRepresentation);

private:

    Handle(MeshDS_NodeRepresentation)   myRepresentation;
