...
{
    Standard_Boolean aMismatch = MeshDS_TypeMismatch(theObject, MeshAbs_OBJ_Cell);
    Standard_TypeMismatch_Raise_if(aMismatch, "MeshDS::Cell()");
