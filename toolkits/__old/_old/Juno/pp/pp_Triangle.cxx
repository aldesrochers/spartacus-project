...
{
    gp_Lin L = gp_Lin(myPoint1, gp_Vec(myPoint1, myPoint2));
...
gp_Pnt pp_Triangle::Centroid() const
{
    ...
    Standard_Real Z = 1./3. * (myPoint1.Z() + myPoint2.Z() + myPoint3.Z());
    return gp_Pnt(X, Y, Z);
}
...
*/
// ============================================================================
Standard_Real pp_Triangle::Distance(const gp_Pnt &thePoint) const
{
    return Plane().Distance(thePoint);
}
...
*/
// ============================================================================
pp_LineSegment pp_Triangle::Edge1() const
{
...
*/
// ============================================================================
pp_LineSegment pp_Triangle::Edge2() const
{
...
*/
// ============================================================================
pp_LineSegment pp_Triangle::Edge3() const
{
    return pp_LineSegment(myPoint3, myPoint1);
}

// ============================================================================
/*!
 *  \brief Plane()
 *  Construct a plane based on triangle centroid and normal vector.
*/
// ============================================================================
gp_Pln pp_Triangle::Plane() const
{
    gp_Vec V1(myPoint1, myPoint2);
    gp_Vec V2(myPoint1, myPoint3);
    gp_Vec N = V1.Crossed(V2).Normalized();
    gp_Pnt P = Centroid();
    return gp_Pln(P, N);
}
