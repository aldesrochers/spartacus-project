...
#ifndef __EM_ElasticTruss1d_hxx__
#define __EM_ElasticTruss1d_hxx__

// Spartacus
#include <EM_Element.hxx>

// Forward declarations
class EM_ElasticTruss1d;

// Handles
DEFINE_STANDARD_HANDLE(EM_ElasticTruss1d, EM_Element);


// ============================================================================
/*!
 *  \brief EM_ElasticTruss1d
 *  Class implementation of a 1d elastic truss element.
*/
// ============================================================================
class EM_ElasticTruss1d : public EM_Element
{

public:
    // constructors
    Standard_EXPORT EM_ElasticTruss1d(const Standard_Real theX1,
                                      const Standard_Real theX2,
                                      const Standard_Real theArea,
                                      const Standard_Real theElasticModulous);
    // destructors
    Standard_EXPORT ~EM_ElasticTruss1d();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(EM_ElasticTruss1d, EM_Element);

};

#endif // __EM_ElasticTruss1d_hxx__
