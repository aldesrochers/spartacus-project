...
public:
    ...
    Standard_EXPORT Standard_Boolean                IsNotEqual(const MeshDS_Object& theOther) const;
...
public:
    ...
    Standard_EXPORT Standard_Boolean    operator == (const MeshDS_Object& theOther) const;
    Standard_EXPORT Standard_Boolean    operator != (const MeshDS_Object& theOther) const;
