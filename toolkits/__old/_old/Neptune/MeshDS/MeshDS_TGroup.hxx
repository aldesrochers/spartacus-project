...
public:
    ...
    Standard_EXPORT const TCollection_AsciiString&  GroupName() const;
    Standard_EXPORT MeshDS_ListOfObject&            Elements();
    Standard_EXPORT MeshDS_ListOfObject&            LinkedMeshes();
    Standard_EXPORT void                            SetGroupName(const TCollection_AsciiString& theGroupName);

protected:

    TCollection_AsciiString     myGroupName;
    MeshDS_ListOfObject         myElements;
    MeshDS_ListOfObject         myLinkedMeshes;
