...
#ifndef __EM1d_Element_hxx__
#define __EM1d_Element_hxx__
...
// Handles
DEFINE_STANDARD_HANDLE(EM1d_Element, Standard_Transient);
...
*/
// ============================================================================
class EM1d_Element : public Standard_Transient
{

public:
    // constructors
    Standard_EXPORT EM1d_Element();
    // destructors
    Standard_EXPORT ~EM1d_Element();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(EM1d_Element, Standard_Transient);

};

#endif // __EM1d_Element_hxx__
