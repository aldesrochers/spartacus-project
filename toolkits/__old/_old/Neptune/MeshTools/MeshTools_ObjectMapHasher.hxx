...
public:
    ...
    static Standard_EXPORT Standard_Integer     HashCode(const MeshDS_Object& theObject,
                                                         Standard_Integer theUpperBound);

    static Standard_EXPORT Standard_Boolean     IsEqual(const MeshDS_Object& theObject1,
