...
*/
// ============================================================================
XSM_UniaxialElastic::XSM_UniaxialElastic(const xsp_Elastic& theProperties,
...
{
    math_Vector F(1, 0.);
    F(1) = myProperties.E() * myProperties.A() * (myCurrentStrain - (myCurrentTemperature - myInitialTemperature) * myProperties.Alpha());
    return F;
}
...
math_Matrix XSM_UniaxialElastic::InitialDerivatives() const
{
    ...
    D(1,1) = myProperties.E() * myProperties.A();
    D(1,2) = -1. * myProperties.E() * myProperties.A() * myProperties.Alpha();
    return D;
}
...
{
    math_Vector F(1, 0.);
    F(1) = myProperties.E() * myProperties.A() * (myPreviousStrain - (myPreviousTemperature - myInitialTemperature) * myProperties.Alpha());
    return F;
}
...
*/
// ============================================================================
xsp_Elastic XSM_UniaxialElastic::Properties() const
{
    return myProperties;
}
