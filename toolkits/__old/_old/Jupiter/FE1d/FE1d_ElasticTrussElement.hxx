...
// Handles
DEFINE_STANDARD_HANDLE(FE1d_ElasticTrussElement, FE1d_TrussElement);


// ============================================================================
/*!
 *  \brief FE1d_ElasticTrussElement
 *  Class implementation of a 1d elastic truss finite element.
 *  [F1,F2] = f(U1,U2,T)
*/
// ============================================================================
class FE1d_ElasticTrussElement : public FE1d_TrussElement
{

public:
    // constructors
    Standard_EXPORT FE1d_ElasticTrussElement(const Standard_Real theX1,
...
public:
    ...
    Standard_EXPORT xsp_Elastic         Section() const;
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(FE1d_ElasticTrussElement, FE1d_TrussElement);
