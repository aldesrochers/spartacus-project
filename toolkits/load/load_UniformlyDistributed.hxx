...
#ifndef __load_UniformlyDistributed_hxx__
#define __load_UniformlyDistributed_hxx__
...
// ============================================================================
/*!
 *  \brief load_UniformlyDistributed
 *  Class implementation of a uniformly distributed load pattern.
*/
// ============================================================================
class load_UniformlyDistributed
{
...
public:
    // constructors
    Standard_EXPORT load_UniformlyDistributed();
    // destructors
    Standard_EXPORT ~load_UniformlyDistributed();
...
#endif // __load_UniformlyDistributed_hxx__
