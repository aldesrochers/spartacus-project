...
public:
    ...
    Standard_EXPORT ModelRep_MechElement1d(const Handle(Mech1d_Element)& theElement);
    // destructors
    Standard_EXPORT ~ModelRep_MechElement1d();
...
public:
    ...
    Standard_EXPORT const Handle(Mech1d_Element)&   Mech1d() const Standard_OVERRIDE;

private:

    Handle(Mech1d_Element)  myElement;
