...
#ifndef __PolyMesh_Group_hxx__
#define __PolyMesh_Group_hxx__
...
class PolyMesh_Group;

// Handles
DEFINE_STANDARD_HANDLE(PolyMesh_Group, PolyMesh_Object)


// ============================================================================
/*!
 *  \brief PolyMesh_Group
*/
// ============================================================================
class PolyMesh_Group : public PolyMesh_Object
{

public:
    // constructors
    Standard_EXPORT PolyMesh_Group();
    Standard_EXPORT PolyMesh_Group(const Standard_Integer theNbCells,
                                     const TCollection_AsciiString& theName = TCollection_AsciiString());
    Standard_EXPORT PolyMesh_Group(const TColStd_Array1OfInteger& theCells,
                                     const TCollection_AsciiString& theName = TCollection_AsciiString());
    // destructors
    Standard_EXPORT ~PolyMesh_Group();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(PolyMesh_Group, PolyMesh_Object)

};


#endif // __PolyMesh_Group_hxx__
