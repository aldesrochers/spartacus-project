...
#include <TColmp_Array1OfNode1d.hxx>

// Forward declarations
class Mesh1d_Grid;

// Handles
DEFINE_STANDARD_HANDLE(Mesh1d_Grid, Standard_Transient)


// ============================================================================
/*!
 *  \brief Mesh1d_Grid
 *  Class implementation of a mesh data structure in 1d space.
*/
// ============================================================================
class Mesh1d_Grid : public Standard_Transient
{
...
public:
    ...
    Standard_EXPORT const mp_Node1d&                        Node(const Standard_Integer theIndex) const;
    Standard_EXPORT const TColmp_Array1OfNode1d&            Nodes() const;
    Standard_EXPORT TColmp_Array1OfNode1d&                  Nodes();
...
private:
    ...
    TColmp_Array1OfNode1d               myNodes;
    TColmp_Array1OfQuadraticLine3N      myQuadraticLines3N;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh1d_Grid, Standard_Transient);
