...
class Mesh_QuadraticLine3N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticLine3N, Mesh_Cell)
...
public:
    ...
    Standard_EXPORT Mesh_QuadraticLine3N(const mp_QuadraticLine3N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticLine3N();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticLine3N, Mesh_Cell);
