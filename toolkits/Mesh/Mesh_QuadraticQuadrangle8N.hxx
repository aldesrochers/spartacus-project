...
#ifndef __Mesh_QuadraticQuadrangle8N_hxx__
#define __Mesh_QuadraticQuadrangle8N_hxx__
...
class Mesh_QuadraticQuadrangle8N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticQuadrangle8N, Mesh_Cell)


// ============================================================================
/*!
 *  \brief Mesh_QuadraticQuadrangle8N
*/
// ============================================================================
class Mesh_QuadraticQuadrangle8N : public Mesh_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh_QuadraticQuadrangle8N();
    Standard_EXPORT Mesh_QuadraticQuadrangle8N(const mp_QuadraticQuadrangle8N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticQuadrangle8N();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticQuadrangle8N, Mesh_Cell);

};


#endif // __Mesh_QuadraticQuadrangle8N_hxx__
