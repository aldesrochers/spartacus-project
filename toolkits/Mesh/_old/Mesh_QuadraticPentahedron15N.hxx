...
#ifndef __Mesh_QuadraticPentahedron15N_hxx__
#define __Mesh_QuadraticPentahedron15N_hxx__
...
class Mesh_QuadraticPentahedron15N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticPentahedron15N, Mesh_Cell)


// ============================================================================
/*!
 *  \brief Mesh_QuadraticPentahedron15N
*/
// ============================================================================
class Mesh_QuadraticPentahedron15N : public Mesh_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh_QuadraticPentahedron15N();
    Standard_EXPORT Mesh_QuadraticPentahedron15N(const mp_QuadraticPentahedron15N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticPentahedron15N();

public:

    Standard_EXPORT const mp_QuadraticPentahedron15N&   Connectivity() const;
    Standard_EXPORT void                                SetConnectivity(const mp_QuadraticPentahedron15N& theConnectivity);
...
private:
    ...
    mp_QuadraticPentahedron15N     myConnectivity;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticPentahedron15N, Mesh_Cell);

};


#endif // __Mesh_QuadraticPentahedron15N_hxx__
