...
class Mesh_QuadraticHexahedron20N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticHexahedron20N, Mesh_Cell)
...
public:
    ...
    Standard_EXPORT Mesh_QuadraticHexahedron20N(const mp_QuadraticHexahedron20N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticHexahedron20N();

public:

    Standard_EXPORT const mp_QuadraticHexahedron20N&   Connectivity() const;
    Standard_EXPORT void                               SetConnectivity(const mp_QuadraticHexahedron20N& theConnectivity);
...
private:
    ...
    mp_QuadraticHexahedron20N     myConnectivity;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticHexahedron20N, Mesh_Cell);
