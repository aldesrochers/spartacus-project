...
#ifndef __Mesh_QuadraticPyramid13N_hxx__
#define __Mesh_QuadraticPyramid13N_hxx__
...
class Mesh_QuadraticPyramid13N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticPyramid13N, Mesh_Cell)


// ============================================================================
/*!
 *  \brief Mesh_QuadraticPyramid13N
*/
// ============================================================================
class Mesh_QuadraticPyramid13N : public Mesh_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh_QuadraticPyramid13N();
    Standard_EXPORT Mesh_QuadraticPyramid13N(const mp_QuadraticPyramid13N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticPyramid13N();

public:

    Standard_EXPORT const mp_QuadraticPyramid13N&   Connectivity() const;
    Standard_EXPORT void                            SetConnectivity(const mp_QuadraticPyramid13N& theConnectivity);
...
private:
    ...
    mp_QuadraticPyramid13N     myConnectivity;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticPyramid13N, Mesh_Cell);

};


#endif // __Mesh_QuadraticPyramid13N_hxx__
