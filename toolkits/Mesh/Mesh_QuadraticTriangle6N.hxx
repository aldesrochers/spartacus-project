...
#ifndef __Mesh_QuadraticTriangle6N_hxx__
#define __Mesh_QuadraticTriangle6N_hxx__
...
class Mesh_QuadraticTriangle6N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticTriangle6N, Mesh_Cell)


// ============================================================================
/*!
 *  \brief Mesh_QuadraticTriangle6N
*/
// ============================================================================
class Mesh_QuadraticTriangle6N : public Mesh_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh_QuadraticTriangle6N();
    Standard_EXPORT Mesh_QuadraticTriangle6N(const mp_QuadraticTriangle6N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticTriangle6N();
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticTriangle6N, Mesh_Cell);

};


#endif // __Mesh_QuadraticTriangle6N_hxx__
