...
class Mesh_LinearPentahedron6N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_LinearPentahedron6N, Mesh_Cell)
...
public:
    ...
    Standard_EXPORT Mesh_LinearPentahedron6N(const mp_LinearPentahedron6N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_LinearPentahedron6N();
...
public:
    ...
    Standard_EXPORT const mp_LinearPentahedron6N&   Connectivity() const;
    Standard_EXPORT void                            SetConnectivity(const mp_LinearPentahedron6N& theConnectivity);
...
private:
    ...
    mp_LinearPentahedron6N     myConnectivity;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh_LinearPentahedron6N, Mesh_Cell);
