...
#ifndef __Mesh_QuadraticPyramid14N_hxx__
#define __Mesh_QuadraticPyramid14N_hxx__
...
class Mesh_QuadraticPyramid14N;

// Handles
DEFINE_STANDARD_HANDLE(Mesh_QuadraticPyramid14N, Mesh_Cell)


// ============================================================================
/*!
 *  \brief Mesh_QuadraticPyramid14N
*/
// ============================================================================
class Mesh_QuadraticPyramid14N : public Mesh_Cell
{
...
public:
    // constructors
    Standard_EXPORT Mesh_QuadraticPyramid14N();
    Standard_EXPORT Mesh_QuadraticPyramid14N(const mp_QuadraticPyramid14N& theConnectivity);
    // destructors
    Standard_EXPORT ~Mesh_QuadraticPyramid14N();
...
public:
    ...
    Standard_EXPORT const mp_QuadraticPyramid14N&   Connectivity() const;
    Standard_EXPORT void                            SetConnectivity(const mp_QuadraticPyramid14N& theConnectivity);
...
private:
    ...
    mp_QuadraticPyramid14N     myConnectivity;

public:

    DEFINE_STANDARD_RTTIEXT(Mesh_QuadraticPyramid14N, Mesh_Cell);

};


#endif // __Mesh_QuadraticPyramid14N_hxx__
