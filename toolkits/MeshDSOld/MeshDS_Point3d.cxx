...
*/
// ============================================================================
MeshDS_Point3d::MeshDS_Point3d(const gp_Pnt& thePoint3d)
...
*/
// ============================================================================
Standard_Real MeshDS_Point3d::X() const
{
    return myPoint3d.X();
}
...
*/
// ============================================================================
Standard_Real MeshDS_Point3d::Y() const
{
    return myPoint3d.Y();
}
...
*/
// ============================================================================
Standard_Real MeshDS_Point3d::Z() const
{
    return myPoint3d.Z();
}
