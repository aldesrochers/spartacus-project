...
// ============================================================================
void MeshDS_Builder::MakeLinearLine2N(MeshDS_Cell &theCell,
                                      const MeshDS_Node1d &theNode1,
                                      const MeshDS_Node1d &theNode2) const
{
    Handle(MeshDS_TCell) aTCell = new MeshDS_TCell(MeshAbs_LinearLine2N1d, 2);
    MakeCell(theCell, aTCell);
    Update(theCell, 1, theNode1);
    Update(theCell, 2, theNode2);
}
...
/*!
 *  \brief Update()
 *  Utility method used to setup a node within a mesh and to connect the cell
 *  to the provided node.
*/
// ============================================================================
void MeshDS_Builder::Update(const MeshDS_Cell &theCell,
                            const Standard_Integer theNodeId,
                            const MeshDS_Node &theNode) const
{
    //const Handle(MeshDS_TCell)& aTCell = *((Handle(MeshDS_TCell)*) &theCell.TCell());
    //const Handle(MeshDS_TNode3d)& aTNode = *((Handle(MeshDS_TNode3d)*) &theNode.TNode());
    //aTCell->SetNode(theNodeId, theNode);
    //aTCell->SetModified();
    //MeshDS_ListOfCell& aList = aTNode->ConnectedCells();
    //aList.Append(theCell);
    //aTNode->SetModified();
}
...
void MeshDS_Builder::Update(const MeshDS_Cell &theCell,
                            const Standard_Integer theNodeId,
                            const MeshDS_Node1d &theNode) const
{
    //const Handle(MeshDS_TCell)& aTCell = *((Handle(MeshDS_TCell)*) &theCell.TCell());
    //const Handle(MeshDS_TNode1d)& aTNode = *((Handle(MeshDS_TNode1d)*) &theNode.TNode());
    //aTCell->SetNode(theNodeId, theNode);
    //aTCell->SetModified();
    //MeshDS_ListOfCell& aList = aTNode->ConnectedCells();
    //aList.Append(theCell);
...
void MeshDS_Builder::Update(const MeshDS_Cell &theCell,
                            const Standard_Integer theNodeId,
                            const MeshDS_Node2d &theNode) const
{
    //const Handle(MeshDS_TCell)& aTCell = *((Handle(MeshDS_TCell)*) &theCell.TCell());
    //const Handle(MeshDS_TNode2d)& aTNode = *((Handle(MeshDS_TNode2d)*) &theNode.TNode());
    //aTCell->SetNode(theNodeId, theNode);
    //aTCell->SetModified();
    //MeshDS_ListOfCell& aList = aTNode->ConnectedCells();
    //aList.Append(theCell);
