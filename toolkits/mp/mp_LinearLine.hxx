...
#ifndef __mp_LinearLine_hxx__
#define __mp_LinearLine_hxx__
...
public:
    // constructors
    Standard_EXPORT mp_LinearLine();
    Standard_EXPORT mp_LinearLine(const Standard_Integer theNode1,
