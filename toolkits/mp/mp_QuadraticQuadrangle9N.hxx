...
#ifndef __mp_QuadraticQuadrangle9N_hxx__
#define __mp_QuadraticQuadrangle9N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_QuadraticQuadrangle9N
*/
// ============================================================================
class mp_QuadraticQuadrangle9N
{
...
public:
    // constructors
    Standard_EXPORT mp_QuadraticQuadrangle9N();
    Standard_EXPORT mp_QuadraticQuadrangle9N(const Standard_Integer theNode1,
...
public:
    ...
    Standard_EXPORT mp_QuadrangleFace9N     Face() const;
...
#endif // __mp_QuadraticQuadrangle9N_hxx__
