...
#ifndef __mp_QuadrilateralFace4N_hxx__
#define __mp_QuadrilateralFace4N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_QuadrilateralFace4N
*/
// ============================================================================
class mp_QuadrilateralFace4N
{
...
public:
    Standard_EXPORT mp_QuadrilateralFace4N();
    Standard_EXPORT mp_QuadrilateralFace4N(const mp_Node& theNode1,
...
public:
    ...
    Standard_EXPORT const mp_Edge2N&        Edge1() const;
    Standard_EXPORT const mp_Edge2N&        Edge2() const;
    Standard_EXPORT const mp_Edge2N&        Edge3() const;
    Standard_EXPORT const mp_Edge2N&        Edge4() const;
...
#endif // __mp_QuadrilateralFace4N_hxx__
