...
#ifndef __mp_QuadraticHexahedron20N_hxx__
#define __mp_QuadraticHexahedron20N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_QuadraticHexahedron20N
*/
// ============================================================================
class mp_QuadraticHexahedron20N
{
...
public:
    // constructors
    Standard_EXPORT mp_QuadraticHexahedron20N();
    Standard_EXPORT mp_QuadraticHexahedron20N(const Standard_Integer theNode1,
...
public:
    ...
    Standard_EXPORT mp_QuadrangleFace8N     Face1() const;
    Standard_EXPORT mp_QuadrangleFace8N     Face2() const;
    Standard_EXPORT mp_QuadrangleFace8N     Face3() const;
    Standard_EXPORT mp_QuadrangleFace8N     Face4() const;
    Standard_EXPORT mp_QuadrangleFace8N     Face5() const;
    Standard_EXPORT mp_QuadrangleFace8N     Face6() const;
...
#endif // __mp_QuadraticHexahedron20N_hxx__
