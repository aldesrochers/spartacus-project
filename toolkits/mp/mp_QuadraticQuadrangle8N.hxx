...
#ifndef __mp_QuadraticQuadrangle8N_hxx__
#define __mp_QuadraticQuadrangle8N_hxx__
...
// ============================================================================
/*!
 *  \brief mp_QuadraticQuadrangle8N
*/
// ============================================================================
class mp_QuadraticQuadrangle8N
{
...
public:
    // constructors
    Standard_EXPORT mp_QuadraticQuadrangle8N();
    Standard_EXPORT mp_QuadraticQuadrangle8N(const Standard_Integer theNode1,
...
public:
    ...
    Standard_EXPORT mp_QuadrangleFace8N     Face() const;
...
#endif // __mp_QuadraticQuadrangle8N_hxx__
