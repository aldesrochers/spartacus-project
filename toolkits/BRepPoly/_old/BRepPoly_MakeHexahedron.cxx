...
*/
// ============================================================================
BRepPoly_MakeHexahedron::BRepPoly_MakeHexahedron(const TopoDS_Vertex& theVertex1,
...
*/
// ============================================================================
BRepPoly_MakeHexahedron::~BRepPoly_MakeHexahedron()
{
...
*/
// ============================================================================
void BRepPoly_MakeHexahedron::Initialize(const TopoDS_Vertex& theVertex1,
                                         const TopoDS_Vertex& theVertex2,
                                         const TopoDS_Vertex& theVertex3,
                                         const TopoDS_Vertex& theVertex4,
                                         const TopoDS_Vertex& theVertex5,
                                         ...
                                         const TopoDS_Vertex& theVertex8)
{
    myVertices.Resize(1, 8, Standard_False);
    myEdges.Resize(1, 12, Standard_False);
    myWires.Resize(1, 6, Standard_False);
    myFaces.Resize(1, 6, Standard_False);
    ...
    // build edge 6
    BRepLib_MakeEdge anEdgeBuilder6(theVertex2, theVertex6);
    ...
    // build edge 7
    BRepLib_MakeEdge anEdgeBuilder7(theVertex3, theVertex7);
    ...
    // build edge 8
    BRepLib_MakeEdge anEdgeBuilder8(theVertex4, theVertex8);
    ...
    // build edge 9
    BRepLib_MakeEdge anEdgeBuilder9(theVertex5, theVertex6);
    ...
    // build edge 10
    BRepLib_MakeEdge anEdgeBuilder10(theVertex6, theVertex7);
    if(!anEdgeBuilder10.IsDone()) {
        if(anEdgeBuilder10.Error() == BRepLib_LineThroughIdenticPoints) {
            myError = BRepPoly_LineThroughIdenticPointsError;
        } else {
            myError = BRepPoly_UnknownError;
        }
    ...
    myEdges.SetValue(10, anEdge10);

    // build edge 11
    BRepLib_MakeEdge anEdgeBuilder11(theVertex7, theVertex8);
    if(!anEdgeBuilder11.IsDone()) {
        if(anEdgeBuilder11.Error() == BRepLib_LineThroughIdenticPoints) {
            myError = BRepPoly_LineThroughIdenticPointsError;
        } else {
            myError = BRepPoly_UnknownError;
        }
    ...
    myEdges.SetValue(11, anEdge11);

    // build edge 12
    BRepLib_MakeEdge anEdgeBuilder12(theVertex8, theVertex5);
    if(!anEdgeBuilder12.IsDone()) {
        if(anEdgeBuilder12.Error() == BRepLib_LineThroughIdenticPoints) {
            myError = BRepPoly_LineThroughIdenticPointsError;
        } else {
            myError = BRepPoly_UnknownError;
        }
    ...
    // build wire 2
    BRepLib_MakeWire aWireBuilder2(anEdge1, anEdge6,
    ...
    // build wire 3
    BRepLib_MakeWire aWireBuilder3(anEdge2, anEdge7,
                                   TopoDS::Edge(anEdge10.Reversed()),
    ...
    // build wire 4
    BRepLib_MakeWire aWireBuilder4(anEdge3, anEdge8,
                                   TopoDS::Edge(anEdge11.Reversed()),
    ...
    // build wire 5
    BRepLib_MakeWire aWireBuilder5(anEdge5,
                                   TopoDS::Edge(anEdge12.Reversed()),
    ...
    // build wire 6
    BRepLib_MakeWire aWireBuilder6(anEdge9, anEdge10, anEdge11, anEdge12);
    if(!aWireBuilder6.IsDone()) {
        myError = BRepPoly_WireError;
        return;
    }
    TopoDS_Wire aWire6 = aWireBuilder6.Wire();
    myWires.SetValue(6, aWire6);
    ...
    // build face 6
    BRepLib_MakeFace aFaceBuilder6(aWire6, Standard_True);
    if(!aFaceBuilder6.IsDone()) {
        if(aFaceBuilder6.Error() == BRepLib_NotPlanar) {
            myError = BRepPoly_FaceNotPlanarError;
        } else {
            myError = BRepPoly_UnknownError;
        }
