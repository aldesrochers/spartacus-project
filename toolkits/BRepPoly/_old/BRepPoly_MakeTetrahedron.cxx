...
*/
// ============================================================================
BRepPoly_MakeTetrahedron::BRepPoly_MakeTetrahedron(const TopoDS_Vertex& theVertex1,
...
*/
// ============================================================================
BRepPoly_MakeTetrahedron::~BRepPoly_MakeTetrahedron()
{
...
*/
// ============================================================================
void BRepPoly_MakeTetrahedron::Initialize(const TopoDS_Vertex &theVertex1,
                                          const TopoDS_Vertex &theVertex2,
                                          const TopoDS_Vertex &theVertex3,
                                          const TopoDS_Vertex &theVertex4)
{
    myVertices.Resize(1, 4, Standard_False);
    myEdges.Resize(1, 6, Standard_False);
    myWires.Resize(1, 4, Standard_False);
    myFaces.Resize(1, 4, Standard_False);
    ...
    // build edge 5
    BRepLib_MakeEdge anEdgeBuilder5(theVertex2, theVertex4);
    ...
    // build edge 6
    BRepLib_MakeEdge anEdgeBuilder6(theVertex3, theVertex4);
    ...
    // build wire 1
    BRepLib_MakeWire aWireBuilder1(TopoDS::Edge(anEdge3.Reversed()),
    ...
    // build wire 2
    BRepLib_MakeWire aWireBuilder2(anEdge1, anEdge5, TopoDS::Edge(anEdge4.Reversed()));
    ...
    // build wire 3
    BRepLib_MakeWire aWireBuilder3(anEdge2, anEdge6, TopoDS::Edge(anEdge5.Reversed()));
    ...
    // build wire 4
    BRepLib_MakeWire aWireBuilder4(anEdge3, anEdge4, TopoDS::Edge(anEdge6.Reversed()));
