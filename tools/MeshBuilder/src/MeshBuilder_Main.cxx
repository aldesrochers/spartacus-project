...
#include <MeshBuilder_Version.hxx>
...
int main(int argc, char** argv)
{
    ...
    anApp.setApplicationDisplayName("MeshBuilder");
    anApp.setApplicationName("spartacus-meshbuilder");
    anApp.setApplicationVersion(QString(MeshBuilder_VERSION_STRING));
    anApp.setWindowIcon(QIcon(":/MeshBuilder.png"));
